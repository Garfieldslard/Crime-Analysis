{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOzy59kAMxWGls4ASEXFc6Z",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Garfieldslard/Crime-Analysis/blob/main/ingestion/notebooks/Ingestion.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "# Load datasets\n",
        "\n",
        "crime_df = pd.read_csv('/content/Crime.csv') # You may need to change your file path\n",
        "dispatch_df = pd.read_csv('/content/Police_Dispatched_Incidents.csv') # You may need to change your file path"
      ],
      "metadata": {
        "colab": {
        ...
        "id": "R6Boe5-TUUsy",
        "outputId": "be581436-5469-4fdb-9314-b0a7d98a9d8a"
      },
      "execution_count": 1,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "/tmp/ipykernel_10543/3499229663.py:5: DtypeWarning: Columns (1) have mixed types. Specify dtype option on import or set low_memory=False.\n",
            "  crime_df = pd.read_csv('/content/Crime.csv') # You may need to change your file path\n",
            "/tmp/ipykernel_10543/3499229663.py:6: DtypeWarning: Columns (2,11,16) have mixed types. Specify dtype option on import or set low_memory=False.\n",
            "  dispatch_df = pd.read_csv('/content/Police_Dispatched_Incidents.csv') # You may need to change your file path\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        ...
        "id": "6QJvRKW-UpAl",
        "outputId": "5ed88523-3fb9-4e55-f6ad-63a939865bdc"
      },
      "execution_count": 2,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "GY0x9udRUfXe",
        "outputId": "a6deab94-c357-4db0-efcc-7550738830fc"
      },
      "execution_count": 3,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "h2OkOb2MdiVT",
        "outputId": "53085711-3b70-4a19-8854-1f8c2215d368"
      },
      "execution_count": 4,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ySY1l5IXRJDx",
        "outputId": "1e068860-61f3-4611-bac1-3fe080eb817b"
      },
      "execution_count": 8,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "lvhELozURfIH",
        "outputId": "1da69eaf-352f-47c7-d1f5-08a6a05da65c"
      },
      "execution_count": 13,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "6nnlYOcgUujZ",
        "outputId": "3cb9c606-67e4-46ba-b4b1-5c86e9c85545"
      },
      "execution_count": 10,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "frywnYS_U8rg",
        "outputId": "38f7f328-ac47-482a-b72c-c4982f716034"
      },
      "execution_count": 15,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "GRyqVXLHYAY8",
        "outputId": "b5b3639c-1fa1-42e8-8661-e56664b7e75e"
      },
      "execution_count": 16,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "DOqmJFr3YjjS",
        "outputId": "8b4c34a4-541f-4a39-b247-7d9041481141"
      },
      "execution_count": 17,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "FE1rVv3CRZ6d",
        "outputId": "22d1d126-6f6f-40c3-a49e-bc281eaaefe8"
      },
      "execution_count": 19,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ElltkYMoRl61",
        "outputId": "d0a70ac5-9582-4119-c450-bc55ba9d160e"
      },
      "execution_count": 20,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "4IHTk0voRwxL",
        "outputId": "a4e7f482-2577-470a-9bd7-35898e91d1d1"
      },
      "execution_count": 22,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "JytBWGH4gWc4",
        "outputId": "2532fda2-b25a-48dd-c634-b4e1188aef81"
      },
      "execution_count": 32,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "AEsiucEnfhEk",
        "outputId": "e0a033b1-1039-42da-d0b0-58db14556be8"
      },
      "execution_count": 33,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "SxWyXREdhoyY",
        "outputId": "038f521f-661e-47e8-bcaa-7c7391405f3f"
      },
      "execution_count": 34,
      "outputs": [
        {
          ...
          "traceback": [
            ...
            "\u001b[0;32m/tmp/ipykernel_10543/3392404628.py\u001b[0m in \u001b[0;36m<cell line: 0>\u001b[0;34m()\u001b[0m\n\u001b[1;32m      1\u001b[0m \u001b[0mcrime_filtered\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mto_csv\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m'crime_filtered.csv'\u001b[0m\u001b[0;34m,\u001b[0m \u001b[0mindex\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;32mFalse\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      2\u001b[0m \u001b[0mdisp_clean\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mto_csv\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m'dispatch_filtered.csv'\u001b[0m\u001b[0;34m,\u001b[0m \u001b[0mindex\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;32mFalse\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m----> 3\u001b[0;31m \u001b[0mdisp_rt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mto_csv\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m'dispatch_rt.csv'\u001b[0m\u001b[0;34m,\u001b[0m \u001b[0mindex\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;32mFalse\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m\u001b[1;32m      4\u001b[0m \u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      5\u001b[0m \u001b[0;32mfrom\u001b[0m \u001b[0mgoogle\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mcolab\u001b[0m \u001b[0;32mimport\u001b[0m \u001b[0mfiles\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "| `crime_clean.csv` | 58,380 | Full crime dataset, NAs handled, all features added |\n",
        "\n",
        "---\n",
        "\n",
